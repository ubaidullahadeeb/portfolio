const services = [
  {
    ...
    price: "Rs.500",
    rating: "4.5",
    image: "images/itNetwork-s/CCTV Installation 1.png",
    includes: [
  ...
  },
  {
    ...
    price: "Rs.500",
    rating: "4.7",
    image: "images/itNetwork-s/Smart Home System 2.png",
  ...
  },
  {
    ...
    price: "Rs.500",
    rating: "4.6",
    image: "images/itNetwork-s/Wi-Fi Setup 1.png",
  ...
  },
  {
    ...
    price: "Rs.500",
    rating: "4.5",
    image: "images/itNetwork-s/Video Door Phone 2.png",
  ...
  },
  {
    ...
    price: "Rs.500",
    rating: "4.7",
    image: "images/itNetwork-s/Smart Locks 1.png",
  ...
  },
  {
    ...
    price: "Rs.500",
    rating: "4.6",
    image: "images/itNetwork-s/Home Theater Setup 1.png",
    includes: ["Safe dismounting", "Indoor & outdoor unit", "Gas recovery"],
    excludes: ["Transportation", "Reinstallation", "Storage"],
  },
  {
    ...
    price: "Rs.500",
    rating: "4.5",
    image: "images/itNetwork-s/Network Cabling 1.png",
    includes: [
      "Dismounting the indoor & outdoor one place.",
      "Mount indoor & outdoor unit to second place.",
      "No repair",
  ...
  },
  {
    ...
    price: "Rs.500",
    rating: "4.7",
    image: "images/itNetwork-s/Server Room Setup 1.png",
    includes: ["Complete AC inspection", "Filter cleaning", "Performance check"],
    excludes: ["Gas refilling", "Spare parts", "Major repairs"],
  },
  {
    ...
    price: "Rs.500",
    rating: "4.6",
    image: "images/itNetwork-s/Access Control System 1.png",
    includes: ["Standard installation", "Up to 10 feet piping", "Gas charging", "Basic testing"],
    excludes: ["Extra piping cost", "Electrical work", "Stand/bracket"],
  },
  {
    id: 10,
    title: "CCTV & NVR Setup",
    subtitle: "Visit & inspection charges",
    originalPrice: "",
    price: "Rs.500",
    rating: "4.5",
    image: "images/itNetwork-s/CCTV & NVR Setup 1.png",
    includes: ["Fault diagnosis", "Basic inspection", "Repair consultation"],
    excludes: ["Actual repair cost", "Spare parts", "Gas refilling"],
  },
  {
    ...
    price: "Rs.500",
    rating: "4.7",
    image: "images/itNetwork-s/Firewall & Security 1.png",
    includes: ["Safe dismounting", "Indoor & outdoor unit", "Gas recovery"],
    excludes: ["Transportation", "Reinstallation", "Storage"],
  },
  {
    ...
    price: "Rs.500",
    rating: "4.6",
    image: "images/itNetwork-s/IT Maintenance 1.png",
    includes: ["Safe dismounting", "Indoor & outdoor unit", "Gas recovery"],
    excludes: ["Transportation", "Reinstallation", "Storage"],
  },
]
